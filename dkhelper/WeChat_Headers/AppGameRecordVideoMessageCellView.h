...
#import "MMScreenRecorderMediaPlayerDelegate-Protocol.h"

@class AppGameRecordVideoMessageViewModel, MMUILabel, MMUIWindow, MMWebImageView, NSString, UIImageView;

@interface AppGameRecordVideoMessageCellView : CommonMessageCellView <MMScreenRecorderMediaPlayerDelegate>
{
