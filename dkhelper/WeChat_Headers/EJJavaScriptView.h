...
@class CADisplayLink, EAGLContext, EJBindingCanvasContext2D, EJBindingCanvasContextWebGL, EJBindingGlobalUtils, EJCanvasContext, EJClassLoader, EJFileSystem, EJFontCache, EJFrameCapture, EJNonRetainingProxy, EJObjectMemoryMgr, EJRenderTriggerCollection, EJSharedOpenGLContext, EJSharedTextureCache, EJTimerCollection, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSOperationQueue, NSString;
@protocol EJGestureDelegate, EJNativeLogViewDelegate, EJPresentable, EJTouchDelegate, EJWindowEventsDelegate;
