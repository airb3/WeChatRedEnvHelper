...
@class AVAsset, EditImageAttr, EditVideoAttr, EditVideoInitialView, MMAsset, NSArray, NSString, UIImage;
...
@property(retain, nonatomic) NSArray *editOptions; // @synthesize editOptions=_editOptions;
