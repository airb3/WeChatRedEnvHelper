...
+ (void)reportChooseLens:(id)arg1 lensName:(id)arg2 lensPosition:(unsigned long long)arg3 enterTime:(unsigned long long)arg4 scene:(unsigned long long)arg5 source:(unsigned long long)arg6;
