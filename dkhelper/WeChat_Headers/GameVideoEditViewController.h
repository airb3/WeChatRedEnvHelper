...
@class EditVideoLogicItem, MMAsset, NSArray, NSDictionary, NSString, UIImage, WAAppActionSheet;
@protocol GameVideoEditViewControllerDelegate;

@interface GameVideoEditViewController : MMUIViewController <EditVideoLogicItemDelegate, WAAppActionSheetDelegate>
{
    _Bool _needExtUrl;
    int _ssid;
...
+ (id)createWithCallback:(id)arg1 callback:(CDUnknownBlockType)arg2;
