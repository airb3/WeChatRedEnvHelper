...
@class EmoticonBoardView, MMEmoticonView, MMGrowTextView, MMQuickSendEmoticonView, MMTransparentButton, NSString, NSURL, RecordView, SelectAttachmentView, SelectAttachmentViewController, ShortVideoToolbar, SolitaireTipsView, UIButton, UIImpactFeedbackGenerator, UIView, VoiceInputView, WASendSessionMsgView;
@protocol MMInputToolViewCustomizationDelegate, MMInputToolViewDelegate;

@interface MMInputToolView : MMUIView <MMQuickSendEmoticonViewDelegate, WASendSessionMsgViewDelegate, EmoticonDescMgrExt, RecordViewDelegate, SolitaireTipsViewDelegate, UITextViewDelegate, ISysCallCheckExt, WCActionSheetDelegate, MMGrowTextViewDelegate, MMTransparentButtonDelegate, SelectAttachmentViewControllerDelegate, VoiceInputViewDelegate, EmoticonBoardViewDelegate, BaseEmoticonViewDelegate, IRecordPermissionCheckExt, ShortVideoBarDelegate>
{
