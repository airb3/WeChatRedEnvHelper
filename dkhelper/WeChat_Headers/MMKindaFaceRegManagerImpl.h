...
@property(retain, nonatomic) MMVoidCallback *m_finishCallback; // @synthesize m_finishCallback=_m_finishCallback;
- (void).cxx_destruct;
- (void)faceRecogPayHandlerDidCancel:(id)arg1;
- (void)faceRecogPayHandlerDidFinish:(id)arg1;
- (void)startFaceImpl:(int)arg1 strPackage:(id)arg2 strPackageSign:(id)arg3 finishCallback:(id)arg4 cancelCallback:(id)arg5;
