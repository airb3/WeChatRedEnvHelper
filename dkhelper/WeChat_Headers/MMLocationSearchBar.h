...
@class MMTableView, MMUISearchBar, NSMutableArray, NSString, UIViewController;
...
@property(retain, nonatomic) MMUISearchBar *m_searchBar; // @synthesize m_searchBar=_m_searchBar;
- (void).cxx_destruct;
