...
@class CLLocation, FavClickStreamHelper, LocationRetriever, MMAutoSearchLogic, MMLocationAttributeBanner, MMLocationPinView, MMPickLocationSearchView, NSMutableArray, NSString, POIItem, PickLocationManager, QMapView, UIAlertView, UIBarButtonItem, UIButton, UIImageView, UIPinchGestureRecognizer, UIView;
