...
@protocol MMScreenRecorderMediaPlayerDelegate;

@interface MMScreenRecorderMediaPlayer : MMUIViewController <WCNetworkMediaCoreDelegate, WCActionSheetDelegate, IVOIPUILogicMgrExt, ForwardMessageLogicDelegate, WCCommitViewResultDelegate>
{
    ...
    id <MMScreenRecorderMediaPlayerDelegate> m_delegate;
    NSString *m_videoUrl;
    NSString *m_thumbUrl;
    NSString *m_title;
    NSString *m_desc;
...
@property(nonatomic) __weak id <MMScreenRecorderMediaPlayerDelegate> m_delegate; // @synthesize m_delegate;
- (void).cxx_destruct;
