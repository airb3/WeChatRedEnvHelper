...
@interface MinimizeTaskMgr : MMService <MinimizeWindowDelegate, MinimizeTaskDataSource, MMUIViewControllerExt, IMMImagePickerManagerExt, MMKernelExt, WAPluginEventExt, IWSVideoExt, WCStoryPreviewStatusExt, MMSightCameraExtention, IMPVideoExt, MMService, MinimizeTransitionInterface>
{
