...
@class MinimizeAbsorbFloatingView, MinimizeGestureCircleView, MinimizeTaskOuterContentView, NSMutableArray, NSMutableDictionary, NSObject, NSString, UIButton, UIView;
