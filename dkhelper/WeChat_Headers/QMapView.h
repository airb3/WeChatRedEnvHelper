...
@class NSArray, NSMutableArray, NSMutableSet, NSString, QAnnotationContainerView, QAppKeyCheck, QBasicMapView, QBasicMapViewLayer, QConfigManager, QDataChecker, QEngineResourceManager, QHandDrawTileOverlay, QIndoorBuilding, QIndoorLevel, QIndoorManager, QMapContentView, QMapDataManager, QMediator, QOverlayContainer, QScaleView, QStatisticer, QStyleManager, QTileOverlayManager, QTrafficManager, QUserLocation, QUserLocationAccessibilityElement, QUserLocationManager, QWorldMapCounter, QWorldTileOverlay, TBRegionChangeDistributor, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
...
@property(retain, nonatomic) QWorldMapCounter *worldMapCounter; // @synthesize worldMapCounter=_worldMapCounter;
