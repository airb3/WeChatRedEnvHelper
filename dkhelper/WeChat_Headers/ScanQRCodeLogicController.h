...
@class GetA8KeyLogic, MMUIViewController, NSDictionary, NSObject, NSOperationQueue, NSString, NewQRCodeScanner, ScanQRCodeResultInfo, ScanQRCodeUrlPrefixRule, ScanWXCodeUrlPrefixRule;
