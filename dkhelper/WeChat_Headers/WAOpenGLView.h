...
#import "EJScreenCaptureDelegate-Protocol.h"

@class EJJavaScriptView, NSString;
@protocol WAOpenGLViewDelegate, WAOpenGlViewScreenCaptureDelegate;

@interface WAOpenGLView : UIView <EJNativeLogViewDelegate, EJFileSystemDelegate, EJScreenCaptureDelegate>
{
    id <WAOpenGLViewDelegate> delegate;
    EJJavaScriptView *_glView;
    id <WAOpenGlViewScreenCaptureDelegate> _screenCaptureDelegate;
}

@property(nonatomic) __weak id <WAOpenGlViewScreenCaptureDelegate> screenCaptureDelegate; // @synthesize screenCaptureDelegate=_screenCaptureDelegate;
