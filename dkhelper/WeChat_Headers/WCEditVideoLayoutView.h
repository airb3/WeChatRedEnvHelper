...
#import "WCEditVideoLogicControlExt-Protocol.h"
#import "WCStoryEditVideoTextViewControllerDelegate-Protocol.h"

@class AVAsset, EVVideoPreviewBrowserView, EditImageEmotionToolAttrView, EditImagePenToolAttrView, EditImageTextToolV2, EditVideoBGMView, EditVideoCropView, EditVideoLogicController, EditVideoMusicController, MMLoadingView, MMUIButton, MMUIImageView, NSString, WCEditImageScrollView, WCStoryMultiModeButton;
@protocol WCEditVideoLayoutViewDelegate;

@interface WCEditVideoLayoutView : MMUIView <EditImageEmotionToolAttrDelegate, WCEditVideoLogicControlExt, EditImageTextInputDelegate, UIGestureRecognizerDelegate, EditImageOperationDelegate, EditImagePenToolAttrDelegate, WCStoryEditVideoTextViewControllerDelegate, EditVideoCropViewDelegate, EditVideoBgmViewDelegate, IUiUtilExt, IMMAssetICloudExt>
{
...
- (void)onClickDone;
- (void)onClickCancel;
- (void)onSendScopeChange:(id)arg1;
- (void)firstShowCrop;
