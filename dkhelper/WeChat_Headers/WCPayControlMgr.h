...
- (unsigned int)startRealnameVerifyLogic:(id)arg1 Data:(id)arg2 realnameWording:(id)arg3 sessionId:(id)arg4;
...
- (unsigned int)startAddPayCardLogic:(id)arg1 Data:(id)arg2 Scene:(int)arg3 realnameReq:(id)arg4 realnameResp:(id)arg5 regResp:(id)arg6;
