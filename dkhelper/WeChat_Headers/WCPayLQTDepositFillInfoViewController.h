...
@interface WCPayLQTDepositFillInfoViewController : WCPayBaseViewController <ILinkEventExt, WCPayLQTSelectCardItemDelegate, UITextFieldDelegate, WCPayLQTSelectDateItemDelegate>
{
