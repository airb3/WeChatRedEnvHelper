...
- (void)SetWCPayPasswordInBind:(id)arg1 RepeatPassword:(id)arg2 PayKey:(id)arg3 VerifySMS:(id)arg4 UserInfo:(id)arg5 isOverseasBankCard:(_Bool)arg6 BindCard:(_Bool)arg7 isOnlyVerify:(_Bool)arg8 data:(id)arg9 sessionId:(id)arg10;
