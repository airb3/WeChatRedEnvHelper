...
@class FaceRecogPayHandler, GetRealnameWordingRsp, NSString, WCPayGetUserExInfoCgi, WCPayRealnameAuthenReq, WCPayRealnameAuthenResp, WCPayRealnameRegResp, WCPaySetUserExInfoCgi;
