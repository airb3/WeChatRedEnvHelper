...
@class InteractionLabel, MMAdaptiveLabel, MMHeadImageView, NSString, RichTextView, UIButton, UIImageView, UILabel, UIView, UrlLabel, WCDataItem, WCTimelineCellABTestBaseTip;
@protocol ILinkEventExt, WCTimeLineCellViewDelegate;

@interface WCTimeLineCellView : MMUIView <MMImageLoaderObserver, WCImageViewDelegate, IContactMgrExt, IStrangerContactMgrExt, WCActionSheetDelegate, RichTextLayoutDelegate, ILinkEventExt, UIAlertViewDelegate, ITranslateSnsMgrExt, WCTimeLineAdCardBaseViewDelegate>
{
