...
@class MMUILabel, MMUIScrollView, MMWebSearchController, NSDictionary, NSString, SharePreConfirmView, UIButton, UIImageView, UILongPressGestureRecognizer, UIView, WCStatTimerHelper, WSDotLoadingView, WSWebRecommendTabsView;
@protocol WSLocalWebViewControllerDelegate;

@interface WSLocalWebViewController : MMUIViewController <MMWebSearchViewDelegate, ITopStoryPluginMsgExt, IWebSearchRedPointMgrExt, HandleHaokanActionExt, MMKernelExt, WSWebRecommendTabsViewDelegate, SharePreConfirmViewDelegate>
{
    int _scene;
