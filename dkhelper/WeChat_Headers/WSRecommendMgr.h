...
@interface WSRecommendMgr : MMService <WSLocalWebViewControllerDelegate, IFunctionMsgExt, MMKernelExt, PBMessageObserverDelegate, MMService, IMinimizeTaskDelegateInterface>
{
